		...
		<fieldset class="col-12">
			...
			<legend>Enter Marks</legend>
				...
				<div class="form-group">
					...
					<input type="text" value='.$_POST['classes'].' disabled></input>
				...
				<div class="form-group">
					...
					<input type="text" value='.$_POST['section'].' disabled></input>
...
<table style="width:1010px">
		...
		foreach ($result_sets as $data) {
			echo '<tr>
					...
					<div class="form-group">
					<div>
					<input type="text" name="marks" value="" class="form-group" maxlength="3" size="3"></input>
					</div>
					...
					<div class="form-group">
					<div>
					<input type="text" name="comments" value="" class="form-group" size="15"></input>
					</div>
					...
					<div class="form-group">
					<div>
					<input type="submit" name="upload" value="upload" class="btn btn-green">
					</div>
		...
		echo '<input type="submit" name="submit marks" value="submit marks" class="m-2 btn btn-blue"> </div>';
