...
<div id="content" class="col-11 col-md-8 col-lg-9 flex-col align-items-center justify-content-start">
	...
	<div class="p-5  w-100 d-flex align-items-center flex-col">
		...
		<div class="w-75 d-flex justify-content-end">
			<a class="t-d-none btn btn-blue-outline" href="<?php echo set_url('pages/classroom_assign_student.php?classroom_id='.$_GET['classroom_id']); ?>">+add new students</a>
		</div>
	</div>
	<hr class="w-100 mb-5">
	...
	<div class="d-flex flex-col col-12 align-items-center border">
		...
		<hr class="w-100 mb-5">
		<form action="classroom_student.php?classroom_id=<?php echo $_GET['classroom_id'] ;?>" method="post" class="col-12 d-flex flex-col align-items-center">
